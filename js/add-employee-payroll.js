/**
 * On event checking the regex of Name 
 * On event listen updating the value of range
 */
...
//Cretes and updates the storage 
...
//Resets the form for next inputs on Submission of current form
const resetForm = () => {
    setValue('#name', '');
